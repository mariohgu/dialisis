                    ...
                    <div class="panel-body" id="formularioMostrar">
                        <form>
                            ...
                            <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-12">
                                ...
                                <input type="date" class="form-control" name="fecha_venMostrar" id="fecha_venMostrar" disabled>
                            </div>
                    ...
                    <div class="panel-body" id="formularioRegistros">
                        <form name="formulario" id="formulario" method="POST">
                            ...
                            <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-12">
                                ...
                                <input type="date" class="form-control" name="fecha_ven" id="fecha_ven" autocomplete="off" required>
                            </div>

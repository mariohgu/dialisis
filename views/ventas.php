                  ...
                  <div class="box">
                    ...
                    <div class="panel-body" id="formularioMostrar">
                        <form>
                            ...
                            <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-12" style="visibility:hidden">
                                <label>Serie(*):</label>
                    ...
                    <div class="panel-body" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          ...
                          <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-12" style="visibility:hidden">
                            <label>Serie:</label>
                            <input type="text" class="form-control" name="serie_comprobante" id="serie_comprobante" maxlength="7" placeholder="Serie" autocomplete="off">
                          </div>
                          <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-12" style="visibility:hidden">
                            <label>Número:</label>
                            <input type="text" class="form-control" name="num_comprobante" id="num_comprobante" maxlength="10" placeholder="Número" autocomplete="off">
                          </div>
                          <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-12" style="visibility:hidden">
                            <label>Impuesto:</label>

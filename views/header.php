...
<head>
  ...
  <title>CDP 2.0 | Inventarios</title>
...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="escritorio.php" class="logo">
      <span class="logo-mini"><b>CDP</b>2</span>
      <span class="logo-lg"><b>DIALISIS </b>2.0</span>
    </a>
            ...
            <ul class="dropdown-menu">
              <li class="user-header">
                ...
                <p>
                  ...
                  <small>Sistema de gestión de almacen</small>
                </p>
              </li>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php
          if ($_SESSION['ventas'] == 1) {
            echo '<li class="treeview">
                    <a href=""><i class="fa fa-shopping-cart"></i> <span>Salidas</span>
                      <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                    </a>
                    <ul class="treeview-menu">
                      <li><a href="ventas.php"><i class="fa fa-circle-o"></i> Salidas</a></li>
                      <li><a href="cliente.php"><i class="fa fa-circle-o"></i> Personal</a></li>
                    </ul>
                  </li>';
          }
        ?>
        <?php
          if ($_SESSION['acceso'] == 1) {
            echo '<li class="treeview">
                    <a href=""><i class="fa fa-folder"></i> <span>Acceso</span>
                      <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                    </a>
                    <ul class="treeview-menu">
        ...
        <?php
          if ($_SESSION['consultav'] == 1) {
            echo '<li class="treeview">
                    <a href=""><i class="fa fa-bar-chart"></i> <span>Consulta Salidas</span>
                      <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                    </a>
                    <ul class="treeview-menu">

...
Class Ingreso
{
    ...
    public function insertar($idproveedor, $idusuario, $tipo_comprobante, $serie_comprobante, $num_comprobante, $fecha_hora, $fecha_ven,$impuesto, $total_compra, $idarticulo, $cantidad, $precio_compra, $precio_venta){
        $sql = "INSERT INTO ingreso (idproveedor, idusuario, tipo_comprobante, serie_comprobante, num_comprobante, fecha_hora, fecha_ven, impuesto, total_compra, estado) 
                VALUES ('$idproveedor', '$idusuario', '$tipo_comprobante', '$serie_comprobante', '$num_comprobante', '$fecha_hora', '$fecha_ven', '$impuesto', '$total_compra', 'Aceptado')";
    ...
    public function mostrar($idingreso){
        $sql = "SELECT i.idingreso, DATE(i.fecha_hora) as fecha, DATE(i.fecha_ven) as fecha_v, i.idproveedor, p.nombre as proveedor, 
